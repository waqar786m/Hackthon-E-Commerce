    ...
    <>
      ...
      <div className="mx-auto h-[285px] bg-gray-100 py-10 px-6 sm:px-28">
        <div className="container mx-auto flex flex-col justify-center items-start h-full">
          <h2 className="text-3xl text-[#101750] font-bold mb-2 text-center sm:text-left">
            Grid Default
          </h2>
          <div className="flex flex-row items-center justify-center sm:justify-start">
            <p className="text-black">Home.Page</p>
            <p className="text-pink-500">.Grid Default</p>
          </div>
        </div>
      </div>
          ...
          {products.map((product) => (
            <div key={product.id} className="overflow-hidden">
              ...
              <div className="p-4 text-center">
                <h3 className="text-base font-semibold text-[#151875] mb-2">{product.name}</h3>
                {/* Color Dots */}
                ...
                <div className="flex justify-center items-center gap-2">
                  ...
                  <span className="text-sm line-through text-[#FB2E86]">{product.oldPrice}</span>
                </div>
              </div>
            </div>
          ))}
