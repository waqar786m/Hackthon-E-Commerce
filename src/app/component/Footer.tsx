export default function Footer() {
  return (
    <footer className="bg-[#EEEFFB] text-gray-700 mt-10">
      {/* Top Section */}
      <div className="container mx-auto py-10 px-20 grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Branding and Subscription */}
        <div className="mb-10 w-[344px]">
          <h2 className="text-2xl font-bold text-indigo-900 mb-6">Hekto</h2>
          <div className="flex items-center space-x-2 mb-6">
            <input
              type="email"
              placeholder="Enter Email Address"
              className="text-[#8A8FB9] flex-1 border border-gray-300 rounded-md px-3 py-2 outline-none"
            />
        ...
        <div className="w-[344px]">
          <h3 className="text-black text-lg font-semibold mb-4 ml-20">
            Categories
          </h3>
          <ul className="text-[#8A8FB9] list-none pl-20 space-y-2">
      ...
      <div className="bg-gray-200 py-6">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-around items-center w-[344px]">
